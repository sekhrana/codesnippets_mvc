 ...
 * @property integer $global_document_id
 * @property integer $is_system_document
 *
...
class DocumentType extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('for_staff,create_for_existing,is_active, for_child, branch_id, is_deleted, global_document_id, is_system_document, created_by, updated_by', 'numerical', 'integerOnly' => true),
            ...
            array('id,create_for_existing,is_active, name, description, title_date_1, title_date_2, title_description, title_notes, for_staff, for_child, branch_id, is_deleted, global_document_id, is_system_document, updated, created, created_by, updated_by', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function relations() {
        ...
        return array(
            'childDocumentDetails' => array(self::HAS_MANY, 'ChildDocumentDetails', 'document_id'),
            'branch' => array(self::BELONGS_TO, 'Branch', 'branch_id'),
            'staffDocumentDetails' => array(self::HAS_MANY, 'StaffDocumentDetails', 'document_id'),
        );
    }
    ...
    public function attributeLabels() {
        return array(
            ...
            'global_document_id' => 'Global Document',
            'is_system_document' => 'System Document',
        );
    }
    ...
    public function search() {
        ...
        $criteria->compare('global_document_id', $this->global_document_id);
        ...
        $criteria->compare('is_system_document', $this->is_system_document);
        $criteria->order = "name";
